...
<div class="container mt-3">
	...
	<c:choose>
		<c:when test="${box.id != null}">
			<form
				action="${pageContext.request.contextPath}/${slug}/box/edit/${box.id}"
				method="post" class="needs-validation" novalidate enctype="multipart/form-data">
		</c:when>
		<c:otherwise>
			<form action="${pageContext.request.contextPath}/${slug}/box/add"
				method="post" class="needs-validation" novalidate enctype="multipart/form-data">
		</c:otherwise>
	</c:choose>
...
<div class="mb-3">
	...
	<div class="d-flex justify-content-center mt-4 mb-5">
		<a href="${pageContext.request.contextPath}/${slug}/box/admin"
